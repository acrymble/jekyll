...
1. The lesson will be moved from `https://programminghistorian.org/en/lesson/LESSON-TITLE` TO `https://programminghistorian.org/lesson/en/retired/LESSON-TITLE`. A redirect will be established, so any links to the original URL will seamlessly point the user to the new URL.
...
[Editor Guidelines for Fostering Lesson Sustainability](/en/editor-guidelines#c-sustainability-review)
