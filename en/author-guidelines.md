...
For a gentle introduction to GitHub Markdown (especially with *Programming Historian*, see [Getting Started with Markdown]({{site.baseurl}}/en/lessons/getting-started-with-markdown), or the concise reference [GitHub Guide to Markdown].
...
### Write Sustainably
PH strives to publish lessons that will be of use to our readers for the foreseeable future. Authors should consult our [lesson retirement policy]({{site.baseurl}}/en/lesson-retirement-policy), which describes how the _Programming Historian_ editorial team manages lessons that have become out-of-date. To aid in creating sustainable lessons, we ask that you keep certain writing guidelines in mind as you create your lesson:
...
To see what happens after you submit a lesson, feel free to browse our [editor guidelines](/en/editor-guidelines), which detail our editorial process. Highlights are below:
...
Congratulations! You've published a lesson at *Programming Historian*!
  ...
  [reviewer guidelines]: /en/reviewer-guidelines.html
  ...
  [live version here]: http://programminghistorian.org/en/lessons/automated-downloading-with-wget#lesson-goals
